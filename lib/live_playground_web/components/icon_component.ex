defmodule LivePlaygroundWeb.IconComponent do
  ...
  defp svg("exclamation_triangle", class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
  ...
  defp svg("rectangle_stack", class) do
    """
  ...
  defp svg("cloud_arrow_up", class) do
    """
  ...
  defp svg("arrow_up_tray", class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  defp svg("cursor_arrow_ripple", class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  defp svg("paper_airplane", class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  defp svg("magnifying_glass", class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
