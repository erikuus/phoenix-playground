defmodule LivePlaygroundWeb.RecipesLive.TabularInsert do
  ...
  def render(assigns) do
      ...
      <div id="tabular_inputs" phx-update="stream" class="space-y-4">
        ...
        >
          ...
          <div class="flex flex-col md:flex-none">
            <.button type="button" look="secondary" phx-click="remove-tabular-input" phx-value-id={tabular_input.id} class="md:flex">
              Remove
            </.button>
          </div>
        </div>
    ...
    <div class="mt-10 space-y-6">
      <%= raw(code("lib/live_playground_web/live/recipes_live/tabular_insert.ex")) %>
