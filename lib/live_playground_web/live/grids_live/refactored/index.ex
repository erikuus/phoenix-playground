defmodule LivePlaygroundWeb.GridsLive.Refactored.Index do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridsLive.Refactored.FormComponent, {:created, language}},
        socket
      ) do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridsLive.Refactored.FormComponent, {:updated, language}},
        socket
      ) do
  ...
  defp get_url(options, base_path \\ "/grids/refactored") do
