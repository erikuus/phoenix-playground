defmodule LivePlaygroundWeb.GridsLive.Sorted.Index do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridsLive.Sorted.FormComponent, {:created, language}},
        socket
      ) do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridsLive.Sorted.FormComponent, {:updated, language}},
        socket
      ) do
  ...
  defp get_url(options, base_path \\ "/grids/sorted") do
