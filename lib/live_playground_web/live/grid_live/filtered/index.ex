defmodule LivePlaygroundWeb.GridLive.Filtered.Index do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridLive.Filtered.FormComponent, {:created, language}},
        socket
      ) do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridLive.Filtered.FormComponent, {:updated, language}},
        socket
      ) do
  ...
  defp get_url(options, base_path \\ "/grid/filtered") do
