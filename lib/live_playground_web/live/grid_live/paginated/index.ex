defmodule LivePlaygroundWeb.GridLive.Paginated.Index do
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridLive.Paginated.FormComponent, {:created, language}},
        socket
      ) do
    socket =
      socket
  ...
  @impl true
  def handle_info(
        {LivePlaygroundWeb.GridLive.Paginated.FormComponent, {:updated, language}},
        socket
      ) do
    socket =
      socket
  ...
  defp get_pagination_url(options, base_path \\ "/grid/paginated") do
