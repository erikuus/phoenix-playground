defmodule LivePlaygroundWeb.IconHelpers do
  def svg_icon_x_mark(class) do
    """
  ...
  def svg_icon_check_mark(class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
  ...
  def svg_icon_exclamation_triangle(class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
  ...
  def svg_icon_rectangle_stack(class) do
    """
  ...
  def svg_icon_cloud_arrow_up(class) do
    """
  ...
  def svg_icon_arrow_up_tray(class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
  ...
  def svg_icon_cursor_arrow_ripple(class) do
    """
    <svg class="#{class}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
