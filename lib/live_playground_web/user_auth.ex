defmodule LivePlaygroundWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_live_playground_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      LivePlaygroundWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule LivePlaygroundWeb.PageLive do
        use LivePlaygroundWeb, :live_view

        on_mount {LivePlaygroundWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{LivePlaygroundWeb.UserAuth, :ensure_authenticated}] do
